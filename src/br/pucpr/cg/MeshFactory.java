...
public class MeshFactory {
    ...
    public static Mesh createModel(Model model){
        return new MeshBuilder()
                .addVector3fAttribute("aPosition", model.getVertices())
                .addVector2fAttribute("aTexCoord", model.getTexCoords())
                .addVector3fAttribute("aNormal", model.getNormals())
                .create();
    }
